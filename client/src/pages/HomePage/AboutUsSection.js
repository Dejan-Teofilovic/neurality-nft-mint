          ...
          <Stack mt={5} spacing={3}>
            ...
            <Typography color={grey[500]} fontSize={{ xs: 14, sm: 18, md: 20 }}>
              <Typography
                ...
                fontWeight={900}
              >
                AI-based high frequency trading
              </Typography> <br />
